...
class diversity():
    ...
    def base_diversity(self,pop):
        ...
        Refer to this more neutrally as "DM01" or Diversity Metric 1.
        """
        ...
        for ii in range(bc):       # For each base
            ...
            for kk in basecnt:            # For every different base observed
                ...
                #print "pf^2 (%s) = pf (%s) * pf (%s)" % (pf2,pf,pf)
        ...
        hsum = 0.0           # Initialize the whole-string H estimate
        for ii in hs:        # For all the h's
            hsum += ii       # Add to a sum
        
        hhat = hsum / bc     # Take the average h' per base
        #print " hhat (%s) = hsum (%s) / bc (%s)" % (hhat,hsum,bc)
    ...
    def tide_diversity(self,pop,s):
        ...
        Refer to this more neutrally as "DM02" or Diversity Metric 2.
        """
