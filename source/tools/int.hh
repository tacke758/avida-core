...
#ifndef LONG_C_UINT
// This class constructs an arbitrary (pre-set) large integer.  All of the
// operators have not been added yet; they will be as they are needed.
...
inline int cUInt::operator==(const cUInt& in_cUInt) const 
{
  int i;
