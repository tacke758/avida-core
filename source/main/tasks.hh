/* task.hh *******************************************************************
 ...
 Time-stamp: <98/07/23 23:50:40 travc>
...
public:
  cTaskEntry() : name("uninitialized"), id(-1), group(NULL), num_bonus(0), 
    bonus_type(NULL), bonus(NULL) {;}
  ~cTaskEntry() { if( bonus )  delete [] bonus; }
