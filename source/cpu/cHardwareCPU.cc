...
// UML Property Methods		
		tInstLibEntry<tMethod>("absence-prop", &cHardwareCPU::Inst_AbsenceProperty, false, 
							   "Create an absence property"),						
		tInstLibEntry<tMethod>("universal-prop", &cHardwareCPU::Inst_UniversialityProperty, false, 
							   "Create an universiality property"),						
		tInstLibEntry<tMethod>("existence-property", &cHardwareCPU::Inst_ExistenceProperty, false, 
							   "Create an existence property"),		
...
{ 
  // Create this property? What sort of data type should it be stored in...?
  return false;
} 
