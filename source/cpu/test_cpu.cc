			       ...
			       const cGenome & genome, int cur_depth)
{
  ...
  if (test_info.GetUseRandomInputs() == false) {
    ...
    input_array[0] = 0x930f149f;  // 10010011 00001111 00010100 10011111
    input_array[1] = 0x8833e53e;  // 10001000 00110011 11100101 00111110
    input_array[2] = 0xe25541eb;  // 11100010 01010101 01000001 11101011
  } else {
