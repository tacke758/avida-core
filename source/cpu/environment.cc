...
{
  if (record_list != NULL) delete record_list;
}
...
void cTestEnvironment::AddDivideRecord(cDivideRecord & in_record)
{
  cDivideRecord * new_record = new cDivideRecord(in_record);
  new_record->SetNext(record_list);
